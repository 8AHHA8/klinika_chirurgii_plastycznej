<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <x-text-input id="pesel" class="block mt-1 w-full" type="text" name="pesel" :value="old('pesel')" required autofocus autocomplete="pesel" />
        ...
        <!-- Email Address -->
        <div class="mt-4">
            <x-input-label for="e-mail" :value="__('Email')" />
            <x-text-input id="e-mail" class="block mt-1 w-full" type="email" name="e-mail" :value="old('email')" required autocomplete="username" />
